...
--
-- Table structure for table `prueba_restore`
--

DROP TABLE IF EXISTS `prueba_restore`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prueba_restore` (
  `id` int DEFAULT NULL,
...
--
-- Dumping data for table `prueba_restore`
--

LOCK TABLES `prueba_restore` WRITE;
/*!40000 ALTER TABLE `prueba_restore` DISABLE KEYS */;
INSERT INTO `prueba_restore` VALUES (1,'dato de prueba');
/*!40000 ALTER TABLE `prueba_restore` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-14 12:22:20
